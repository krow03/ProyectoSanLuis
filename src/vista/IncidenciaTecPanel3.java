...
public class IncidenciaTecPanel3 extends JFrame {
	...
	public IncidenciaTecPanel3(SolicitudDTO idto) {
		...
		System.out.println(idto.getIdComponente());
		ComponenteDTO ctdo = gc.getComponenteId(idto.getIdComponente());
		System.out.println(ctdo.getDescripcion());
		if(ctdo instanceof HardwareDTO) {
			hardSoft = "Hardware";
		}
		if(ctdo instanceof SoftwareDTO) {
			hardSoft = "Software";
		}
