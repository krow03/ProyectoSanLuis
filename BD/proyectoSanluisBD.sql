...
-- -----------------------------------------------------
-- Data for table `SanluisDB`.`Centro`
-- -----------------------------------------------------
START TRANSACTION;
USE `SanluisDB`;
INSERT INTO `SanluisDB`.`Centro` (`idCentro`, `nombre_centro`, `ciudad_centro`) VALUES (1, 'sanluis', 'bilbao');
...
START TRANSACTION;
USE `SanluisDB`;
INSERT INTO `SanluisDB`.`Aulas` (`idAulas`, `Centro_idCentro`, `rangoIps`, `nombre`, `descripcion`, `capacidad`) VALUES (1, 1, '0-0-0', 'aula 1', 'administracion', 5);
...
START TRANSACTION;
USE `SanluisDB`;
INSERT INTO `SanluisDB`.`Stock` (`idStock`, `unidadesStock`, `limiteInferior`, `descripcion`) VALUES (1, 1, 2, 'stockEquipos');
INSERT INTO `SanluisDB`.`Stock` (`idStock`, `unidadesStock`, `limiteInferior`, `descripcion`) VALUES (2, 1, 1, 'stockLicenciasPhotoshop');
