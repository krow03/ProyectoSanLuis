...
CREATE TABLE IF NOT EXISTS `SanluisDB`.`Aulas` (
  ...
  `capacidad` INT NULL,
  PRIMARY KEY (`idAulas`),
  INDEX `fk_Aulas_Centro1_idx` (`Centro_idCentro` ASC) ,
...
CREATE TABLE IF NOT EXISTS `SanluisDB`.`Usuarios_has_Aulas` (
  ...
  INDEX `fk_Usuarios_has_Aulas_Aulas1_idx` (`Aulas_idAulas` ASC) ,
  INDEX `fk_Usuarios_has_Aulas_Usuarios1_idx` (`Usuarios_idUsuarios` ASC) ,
