...
START TRANSACTION;
USE `SanluisDB`;
INSERT INTO `SanluisDB`.`Proveedores` (`idProveedores`, `cif`, `nombre`, `email`, `direccion`, `telef`, `pass`) VALUES (1, 'aaa', 'aaaa', 'aa@aa.com', 'aaaa', 'aaa', 'proveedor');
